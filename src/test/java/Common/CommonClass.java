...
public class CommonClass {
	...
	public void openGeneralSettings(String shippingIsTaxable, String enableCalculateTax, String decimalValue, String weightDecimalValue, String orderAmountValue) throws InterruptedException {
		...
		WebElement isShipTax = driver.findElement(EP.isShippingTaxable);

		if (isShipTax.isSelected() != shippingIsTaxable.equalsIgnoreCase("YES")) {
			isShipTax.click();
		}
		// scroll element into view
		((JavascriptExecutor) driver)
		.executeScript("arguments[0].scrollIntoView({block:'center'});", driver.findElement(EP.WeightDecimalDD));

		//Decimal Settings
		driver.findElement(EP.CurrencyDecimalDD).click();


		WebElement option1 =
				driver.findElement(By.xpath("//div[@role='listbox']//*[normalize-space()='"+decimalValue+"']"));
		option1.click();

		driver.findElement(EP.WeightDecimalDD).click();

		WebElement option2 =
				driver.findElement(By.xpath("//div[@role='listbox']//*[normalize-space()='"+weightDecimalValue+"']"));
		option2.click();



		driver.findElement(EP.OrderAmountDecimalDD).click();

		WebElement option3 =
				driver.findElement(By.xpath("//div[@role='listbox']//*[normalize-space()='"+orderAmountValue+"']"));
		option3.click();
		
		driver.findElement(EP.ShowAdvanced).click();
		

		WebElement isTaxEnable = driver.findElement(EP.isCalculateTax);
		
		
		if (isTaxEnable.isSelected() != enableCalculateTax.equalsIgnoreCase("YES")) {
			isTaxEnable.click();
		}
